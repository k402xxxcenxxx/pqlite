...
- 🎯 Entry points to execute your program using `python -m <pqlite>` or `$ pqlite` with basic CLI argument parsing.
...
Awesome pqlite created by k402xxxcenxxx
...
```py
from pqlite import BaseClass
from pqlite import base_function
